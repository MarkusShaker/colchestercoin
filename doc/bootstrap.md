...
### Download the Blockchain from the ColchesterCoinNode Project

The ColchesterCoin node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by ColchesterCoinNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.colchestercoinnode.org/bootstrap.dat](http://mango.colchestercoinnode.org/bootstrap.dat)
* [http://apple.colchestercoinnode.org/bootstrap.dat](http://apple.colchestercoinnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.colchestercoinnode.org/bootstrap.dat](http://bootstrap.colchestercoinnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.colchestercoinnode.org/bootstrap.dat       //downloads bootstrap into current directory
