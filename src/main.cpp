...
#if defined(NDEBUG)
# error "ColchesterCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ColchesterCoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("colchestercoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // ColchesterCoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // ColchesterCoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
