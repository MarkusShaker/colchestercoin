...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ColchesterCoin Core colchestercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  colchestercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded colchestercoin transaction") + "\n" +
              "  colchestercoin-tx [options] -create [commands]   " + _("Create hex-encoded colchestercoin transaction") + "\n" +
              "\n";
